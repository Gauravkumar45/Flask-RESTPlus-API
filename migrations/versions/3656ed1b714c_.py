...
Revision ID: 3656ed1b714c
Revises: 6a0ba58b459b
Create Date: 2021-06-23 23:48:33.371700
...
revision = '3656ed1b714c'
down_revision = '6a0ba58b459b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('Users', sa.Column('displayname', sa.String(length=100), nullable=True))
    op.add_column('Users', sa.Column('email', sa.String(length=100), nullable=True))
    op.add_column('Users', sa.Column('insertdate', sa.DateTime(), nullable=True))
    op.add_column('Users', sa.Column('insertuserid', sa.Integer(), nullable=True))
    op.add_column('Users', sa.Column('isactive', sa.Boolean(), server_default='false', nullable=True))
    op.add_column('Users', sa.Column('lastdirectoryupdate', sa.String(length=10), nullable=True))
    op.add_column('Users', sa.Column('passwordhash', sa.String(length=86), nullable=True))
    op.add_column('Users', sa.Column('passwordsalt', sa.String(length=10), nullable=True))
    op.add_column('Users', sa.Column('publicid', sa.String(length=100), nullable=True))
    op.add_column('Users', sa.Column('source', sa.String(length=4), nullable=True))
    op.add_column('Users', sa.Column('updatedate', sa.DateTime(), nullable=True))
    op.add_column('Users', sa.Column('updateuserid', sa.Integer(), nullable=True))
    op.add_column('Users', sa.Column('userid', sa.Integer(), autoincrement=True, nullable=False))
    op.add_column('Users', sa.Column('userimage', sa.String(length=100), nullable=True))
    op.add_column('Users', sa.Column('username', sa.String(length=100), nullable=True))
    op.create_unique_constraint(None, 'Users', ['publicid'])
    op.drop_column('Users', 'UserId')
    op.drop_column('Users', 'DisplayName')
    op.drop_column('Users', 'PasswordHash')
    op.drop_column('Users', 'UpdateDate')
    op.drop_column('Users', 'UpdateUserId')
    op.drop_column('Users', 'UserImage')
    op.drop_column('Users', 'Password')
    op.drop_column('Users', 'Email')
    op.drop_column('Users', 'InsertUserId')
    op.drop_column('Users', 'Username')
    op.drop_column('Users', 'Source')
    op.drop_column('Users', 'PasswordSalt')
    op.drop_column('Users', 'IsActive')
    op.drop_column('Users', 'LastDirectoryUpdate')
    op.drop_column('Users', 'InsertDate')
...
def downgrade():
    ...
    op.alter_column('drivers', 'driverid',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.add_column('Users', sa.Column('InsertDate', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('LastDirectoryUpdate', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('Users', sa.Column('IsActive', sa.SMALLINT(), server_default=sa.text('1'), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('PasswordSalt', sa.VARCHAR(length=10), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('Source', sa.VARCHAR(length=4), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('Username', sa.VARCHAR(length=100), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('InsertUserId', sa.INTEGER(), autoincrement=False, nullable=False))
    ...
    op.add_column('Users', sa.Column('UserImage', sa.VARCHAR(length=100), autoincrement=False, nullable=True))
    op.add_column('Users', sa.Column('UpdateUserId', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('Users', sa.Column('UpdateDate', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('Users', sa.Column('PasswordHash', sa.VARCHAR(length=86), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('DisplayName', sa.VARCHAR(length=100), autoincrement=False, nullable=False))
    op.add_column('Users', sa.Column('UserId', sa.INTEGER(), sa.Identity(always=True, start=1, increment=1, minvalue=1, maxvalue=2147483647, cycle=False, cache=1), autoincrement=True, nullable=False))
